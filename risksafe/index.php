            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div style="padding-bottom:30px;"><img src="img/logo.png"></div>
                        <h1>RiskSafe Risk assessment</h1><br>
                        
                        <h4>“Conduct Risk Assessments, Audit of Controls, Track Incidents, Create Treatment Plans and manage your Compliance risks”<br>
                        “Built by Compliance Risk and Audit professionals with over a decade of experience and tap into our expertise”</h4>
...
<a name="sg"></a>
        <div class="container">
          ...
          <form  role="form" class="lead" action="rs/controller/users.php" method="post">
