...
class ApplicableProcedure {
  ...
  public function addApplicableProcedure($procedureTitle, $procedureNumber, $procedureDescription, $procedureEffectiveDate, $procedureReviewDate, $applicability, $ComplianceRequirements,  $resources, $procedureApproval, $procedureReview, $procedureAcknowledgment) {
    ...
    $query = "INSERT INTO as_procedures (procedure_user_id, ProcedureTitle, ProcedureNumber, ProcedureDescription, ProcedureEffectiveDate, ProcedureReviewDate, Applicability, ComplianceRequirements, Resources,  ProcedureApproval, ProcedureReview, ProcedureAcknowledgment) VALUES ('$userId', '$procedureTitle', '$procedureNumber', '$procedureDescription', '$procedureEffectiveDate', '$procedureReviewDate', '$applicability', '$ComplianceRequirements', '$resources', '$procedureApproval', '$procedureReview', '$procedureAcknowledgment')";
...
public function editApplicableProcedure(
    ...
    $query = "UPDATE as_procedures SET ProcedureTitle = '$procedureTitle', ProcedureNumber = '$procedureNumber', ProcedureDescription = '$procedureDescription', ProcedureEffectiveDate = '$procedureEffectiveDate', ProcedureReviewDate = '$procedureReviewDate', Applicability = '$applicability', ComplianceRequirements = '$ComplianceRequirements',  Resources = '$resources', ProcedureApproval = '$procedureApproval', ProcedureReview = '$procedureReview', ProcedureAcknowledgment = '$procedureAcknowledgment' WHERE id = '$id'";
